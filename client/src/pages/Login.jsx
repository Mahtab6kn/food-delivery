...
const Login = () => {
  ...
  return (
    <div className="template d-flex justify-content-center align-items-center bg-info">
      <div className="form_container  p-5 rounded bg-white">
        ...
        <p className="text-end mt-3">
          <Link to='#' className='me-5'>Forgot Password</Link>New User?<Link to='/signup' className="ms-2">Sign Up</Link>
        </p>
